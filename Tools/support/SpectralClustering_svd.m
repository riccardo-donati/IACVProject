...
function [Grps , SingVals, LapKernel, wss] = SpectralClustering_svd(CKSym,n,mth)
...
switch lower(mth)
    ...
    case 'normalized'
        ...
        SingVals = diag(sKS);
        [Grps,~,wss] = kmeans(kerKS,n,'start','sample','maxiter',MAXiter,'replicates',REPlic,'EmptyAction','singleton');
        LapKernel = kerKS;
end
%
