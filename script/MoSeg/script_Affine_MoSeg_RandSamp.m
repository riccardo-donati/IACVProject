...
for Alpha = AlphaRange
    ...
    result_filepath = fullfile(result_path,sprintf('Error_silhouette_params_RandSamp_nhpf-%d_alpha-%g.mat',...
    ...
    for s_i = seq_range
        ...
        [ClusterIdx{s_i}, ~, LapKernel] = SpectralClustering_svd(K,nMotion,'normalized');
    ...
    save(result_filepath, 'observations', 'error','ClusterIdx');
