...
for Alpha = AlphaRange
    ...
    for s_i = seq_range
        ...
        %%%  LapKernel are the last n columns of Laplacian used for kMeans 
        %%% in the SpectralClustering_svd function
        
        [ClusterIdx{s_i}, ~, LapKernel,wss] = SpectralClustering_svd(K,nMotion,'normalized');
        observations{s_i} = LapKernel;
        allWSS{s_i} = wss;
    ...
    save(result_filepath,'observations', 'error','ClusterIdx','allWSS');
