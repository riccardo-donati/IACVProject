%%
% In this file we just build the video trend of the silhouettes of ("fundamental", "fundamentalt", "fundamentala", "homography")
% that we found in VisualizeModelsSilhouettePlots.m
...
models = ["fundamental", "fundamentalt", "fundamentala", "homography"];
%models = ["GRIC Tuned", "RobustResiduals"];
